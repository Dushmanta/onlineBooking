...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        body = 'You have a new message for the  ' + name + ':-----:' + message + \
               email + '. Please check your admin panel for more ' \
                                                                                 'info. '
...
def appointment(request):
    if request.method == 'POST':
        ...
        obj = Appointment.objects.create(name=name, email=email, service=service, contact=contact, date=date, time=time,
                                         note=note)
...
def success(request):
    ...
    subject = 'New Inquiry for ' + stylist + ' Please connect with him/her'
    ...
    body = 'You have a new Inquiry for the  ' + name + ':-----:' + contactNum + '. Please check your admin panel for more ' \
                                                                          'info. '
    send_mail(subject, body, settings.EMAIL_HOST_USER, my_email, fail_silently=False)
